...
public class AdHawkServer {
	...
	public static String findAd(String fingerprint) throws AdHawkException {
		...
		return postTo("http://adhawk.sunlightfoundation.com/api/ad/", params);
	}
	...
	public static String postTo(String url, Map<String,String> params) throws AdHawkException {
